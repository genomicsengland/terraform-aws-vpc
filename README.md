...
| ecr\_dkr\_endpoint\_policy | A JSON string containing the policy to apply to this endpoint | `string` | `""` | no |
...
| s3\_endpoint\_policy | A JSON string containing the policy to apply to this endpoint | `string` | `""` | no |
